...
export const docRationale: Record<string, string> = {
  "intended-purpose":
    "{{intended-purpose|의도된 목적}}은 규제 적용 범위·분류·성능 요구의 '원점'이다. 여기서 한 단어가 틀어지면 이후 모든 증거가 잘못된 기준으로 만들어지므로, 가장 먼저 정확히 못 박아 재작업과 심사 거절을 막는다.",
  "qualification-statement":
    "내 제품이 애초에 IVDR 대상인지부터 확정해야 불필요하거나 누락된 규제 부담을 피한다. 적용 여부를 근거와 함께 남겨 당국·NB 질의에 즉시 답할 수 있게 한다.",
  "classification-rationale":
    "클래스는 {{notified-body|NB}} 개입·평가 경로·전환 기한을 통째로 결정한다. 분류와 그 근거를 남기는 것은 '왜 이 경로인가'를 입증해 심사에서 가장 먼저 신뢰를 얻기 위함이다.",
  ...
  "tech-doc-toc-gspr":
    "{{gspr|GSPR}}은 모든 IVD가 지켜야 할 안전·성능 요구의 목록이다. 각 요구에 증거를 매핑하는 것은 적합성을 빠짐없이·추적 가능하게 입증하는 뼈대를 만들기 위함이다.",
  "labelling-spec":
    "사용자는 라벨·{{ifu|IFU}}만 보고 기기를 쓴다. 정확한 정보 표기는 오용으로 인한 환자 위해를 막고 법적 정보 제공 의무를 충족하기 위함이다.",
  ...
  "performance-eval-plan":
    "IVDR {{annex-xiii|Annex XIII}}은 '증거 기반' 성능평가를 요구한다. {{pep-per|PEP}}는 PER보다 먼저 작성해 NB·시험기관과 설계를 합의하는 청사진이다. MDCG 2025-5는 성능연구 유형과 절차를 명확히 하고 있다.",
  "scientific-validity":
  ...
  "performance-eval-report":
    "흩어진 성능 증거를 하나의 결론으로 종합해 '이 기기는 의도된 목적에 충분하다'를 선언한다. {{notified-body|NB}} 심사의 핵심 산출물이다.",
  "risk-management-plan":
    "IVDR Annex I {{gspr|GSPR}} 8조는 위험관리가 제품 수명 전주기에 걸쳐 수행돼야 한다고 규정한다. 위험이 없다고 주장하는 것은 NB가 수용하지 않으며, 잔여위험의 수용 근거가 명확해야 한다.",
  "risk-management-file":
    "계획대로 위험이 실제로 통제·검증되었는지 증거로 남겨야 한다. 잔여위험이 수용 가능함을 입증하는 책임 기록이다.",
  fmea:
    "{{fmea|FMEA}}는 부품·공정·사용 단계의 잠재 고장이 어떤 위해로 이어지는지 짚는 상향식(bottom-up) 분석이다. '무엇이 어떻게 잘못될 수 있는가'를 빠짐없이 드러내 통제수단을 설계하고, ISO 14971 위험관리 파일을 구체적 근거로 뒷받침하기 위함이다.",
  "usability-file":
    "사용 오류는 가장 흔한 위해 원인 중 하나다. 사용자가 실수 없이 쓸 수 있는지 검증해 현실의 사용 위험을 줄인다.",
  "qms-ivdr-matrix":
    "품질은 문서 한 장이 아니라 시스템으로 보장된다. {{iso-13485|ISO 13485}}에 IVDR 고유 요구를 연결해 일관된 품질과 규제 준수의 토대를 만든다.",
  "doc-record-control":
  ...
  "nb-application":
    "Class A 비멸균 외에는 제3자 검증 없이 시장에 나갈 수 없다. 객관적 인증으로 적합성에 대한 신뢰를 확보한다. {{notified-body|NB}} 슬롯 지연은 곧 시장 차단이므로 조기 준비가 핵심이다.",
  "declaration-of-conformity":
    "제조자가 법적 책임을 지고 'IVDR을 충족한다'고 선언하는 문서다. {{ce-marking|CE}} 부착의 법적 근거이자 책임 소재의 명문화다.",
  ...
  "device-registration":
    "{{eudamed|EUDAMED}} 등록은 투명한 시장 감시의 전제다. 미등록은 곧 합법 출시 불가이므로 의무 기한 내 완료해야 한다.",
  "udi-assignment":
    "문제 발생 시 어떤 기기인지 전 세계적으로 즉시 식별·추적할 수 있어야 한다. 리콜·추적성의 핵심 인프라다.",
  "pms-plan":
    "IVDR 인증은 출시 시점의 결과물이 아니라 지속적 의무다. MDCG 2025-10은 MDR/IVDR 통합 PMS 지침을 제공한다. Class C·D는 매년 {{pms|PSUR}}을 제출해야 하며, SSCP도 의무다.",
  "pms-report":
  ...
  ssp: "{{ssp|SSP}}는 기기의 안전·성능을 일반인이 볼 수 있게 공개 요약하는 IVDR 고유 문서다. 투명성으로 사용자 신뢰와 정보에 입각한 선택을 보장한다(Class C·D 필수).",
  prrc: "{{prrc|PRRC}}는 규제 준수를 책임지는 자격 있는 담당자를 명문화해, 적합성·바이질런스·기술문서 관리의 책임 소재를 분명히 한다.",
